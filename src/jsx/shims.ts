...
declare global {
  module JSX {  
    ...
    type BaseValue = string | number | boolean | undefined | null
    type ComponentChild = ComponentChild[] | Reactive<BaseValue> | ((slots: Slots) => Node) | Node;
    ...
    type EventHandler<TEvent extends Event> = (this: Node, ev: TEvent) => void;
    ...
    interface DOMAttributes extends VAttributes {
        ...
        onInputCapture?: InputEventHandler;
